...
class PogostickV2Env(gym.Env):
    ...
    """
    Goal: Craft 1 polycraft:wooden_pogo_stick
    ...
    def __init__(self, env=None):
        ...
        self.block_in_front_str = 'minecraft:air'
        self.block_in_front_id = 0  # minecraft:air
        self.block_in_front_location = (0, 0)  # row, column
        self.items = {'minecraft:air', 'minecraft:crafting_table', 'minecraft:planks', 'polycraft:wooden_pogo_stick', 'polycraft:sack_polyisoprene_pellets', 'minecraft:stick', 'minecraft:log', 'polycraft:tree_tap', 'minecraft:bedrock'}
        self.items_id = self.set_items_id(self.items)  # {'minecraft:crafting_table': 1, 'minecraft:planks': 2, ...}  # minecraft:air's ID is 0
        self.unbreakable_items = {'minecraft:air', 'minecraft:bedrock'}
        self.goal_item_to_craft = 'polycraft:wooden_pogo_stick'
        # items_quantity when the episode starts, do not include minecraft:bedrock, quantity must be more than 0
        self.items_quantity = {'minecraft:crafting_table': 1, 'minecraft:log': 5}
        ...
        self.manipulation_actions_id = {'Forward': 0, 'Left': 1, 'Right': 2, 'Break': 3, 'Place_tree_tap': 4,
                                        'Extract_rubber': 5, 'Place_crafting_table': 6}
        self.actions_id.update(self.manipulation_actions_id)
        self.recipes = {'polycraft:wooden_pogo_stick': {'input': {'minecraft:stick': 4, 'minecraft:planks': 2, 'polycraft:sack_polyisoprene_pellets': 1}, 'output': {'polycraft:wooden_pogo_stick': 1}},
                        'minecraft:stick': {'input': {'minecraft:planks': 2}, 'output': {'minecraft:stick': 4}},
                        'minecraft:planks': {'input': {'minecraft:log': 1}, 'output': {'minecraft:planks': 4}},
                        'polycraft:tree_tap': {'input': {'minecraft:planks': 5, 'minecraft:stick': 1}, 'output': {'polycraft:tree_tap': 1}}}
        #TODO: align recipe format and construction with polycraft
        #   Or edit detectors.py in RL to accomodate NG differently
        self.polycraft_recipes = {'polycraft:tree_tap': [{'ingredients': {'0': {'Item': 'minecraft:planks', 'stackSize': 1, 'slot': 0}, '1': {'Item': 'minecraft:stick', 'stackSize': 1, 'slot': 1}, '2': {'Item': 'minecraft:planks', 'stackSize': 1, 'slot': 2}, '3': {'Item': 'minecraft:planks', 'stackSize': 1, 'slot': 3}, '4': None, '5': {'Item': 'minecraft:planks', 'stackSize': 1, 'slot': 5}, '6': None, '7': {'Item': 'minecraft:planks', 'stackSize': 1, 'slot': 7}, '8': None}, 'output_item': {'Item': 'polycraft:tree_tap', 'stackSize': 1, 'slot': 9}}], 'polycraft:wooden_pogo_stick': [{'ingredients': {'0': {'Item': 'minecraft:stick', 'stackSize': 1, 'slot': 0}, '1': {'Item': 'minecraft:stick', 'stackSize': 1, 'slot': 1}, '2': {'Item': 'minecraft:stick', 'stackSize': 1, 'slot': 2}, '3': {'Item': 'minecraft:planks', 'stackSize': 1, 'slot': 3}, '4': {'Item': 'minecraft:stick', 'stackSize': 1, 'slot': 4}, '5': {'Item': 'minecraft:planks', 'stackSize': 1, 'slot': 5}, '6': None, '7': {'Item': 'polycraft:sack_polyisoprene_pellets', 'stackSize': 1, 'slot': 7}, '8': None}, 'output_item': {'Item': 'polycraft:wooden_pogo_stick', 'stackSize': 1, 'slot': 9}}], 'minecraft:planks': [{'ingredients': {'0': {'Item': 'minecraft:log', 'stackSize': 1, 'slot': -1}, '1': None, '2': None, '3': None}, 'output_item': {'Item': 'minecraft:planks', 'stackSize': 4, 'slot': 9}}], 'minecraft:stick': [{'ingredients': {'0': {'Item': 'minecraft:planks', 'stackSize': 1, 'slot': 0}, '1': None, '2': None, '3': {'Item': 'minecraft:planks', 'stackSize': 1, 'slot': 3}, '4': None, '5': None, '6': None, '7': None, '8': None}, 'output_item': {'Item': 'minecraft:stick', 'stackSize': 4, 'slot': 9}}], 'minecraft:crafting_table': [{'ingredients': {'0': {'Item': 'minecraft:planks', 'stackSize': 1, 'slot': 0}, '1': {'Item': 'minecraft:planks', 'stackSize': 1, 'slot': 1}, '2': None, '3': {'Item': 'minecraft:planks', 'stackSize': 1, 'slot': 3}, '4': {'Item': 'minecraft:planks', 'stackSize': 1, 'slot': 4}, '5': None, '6': None, '7': None, '8': None}, 'output_item': {'Item': 'minecraft:crafting_table', 'stackSize': 1, 'slot': 9}}]}
    ...
    def reset(self, map_size=None, items_id=None, items_quantity=None):
        ...
        self.map = np.zeros((self.map_size - 2, self.map_size - 2), dtype=int)  # minecraft:air=0
        self.map = np.pad(self.map, pad_width=1, mode='constant', constant_values=self.items_id['minecraft:bedrock'])

        """
        available_locations: locations 1 block away from the minecraft:bedrock are valid locations to place items and agent
    ...
    def add_item_to_map(self, item, num_items):
        ...
        while True:
            ...
            # If at (r, c) is minecraft:air, and its North, South, West and East are also minecraft:air, add item
    ...
    def set_items_id(self, items):
        ...
        # Temp change for quick NG compatability
        self.id_items = [None for _ in range(len(items_id))]
        for item in items_id:
            self.id_items[items_id[item]] = item
    ...
    def step(self, action_id):
        ...
        if action_id == self.actions_id['Forward']:
            ...
            self.update_block_in_front()
            # If block in front is not minecraft:air and minecraft:bedrock, place the block in front in inventory
            if self.block_in_front_str not in self.unbreakable_items:
                ...
                if self.block_in_front_str == 'minecraft:log':
            ...
            if self.inventory_items_quantity['polycraft:tree_tap'] >= 1:
                if self.block_in_front_str == 'minecraft:air':
                    r, c = self.block_in_front_location
                    self.map[r][c] = self.items_id['polycraft:tree_tap']  # Place_tree_tap
                    self.inventory_items_quantity['polycraft:tree_tap'] -= 1
                    message = "Block tree_tap placed"

                    # Make sure that block_in_front_location is next to a tree
                    block_in_front_next_to_tree = self.is_block_in_front_next_to('minecraft:log')
            ...
            step_cost = 300.0
        elif action_id == self.actions_id['Place_crafting_table']:
            if self.inventory_items_quantity['minecraft:crafting_table'] >= 1:
                if self.block_in_front_str == 'minecraft:air':
                    r, c = self.block_in_front_location
                    self.map[r][c] = self.items_id['minecraft:crafting_table']  # Place_polycraft:tree_tap
                    self.inventory_items_quantity['minecraft:crafting_table'] -= 1
                    message = "Block minecraft:crafting_table placed"
                else:
                    result = False
                    message = "Block " + self.block_in_front_str + " already exists when trying to place block"
            else:
            ...
            if self.block_in_front_str == 'polycraft:tree_tap':
                if block_in_front_next_to_tree:
                    self.inventory_items_quantity['polycraft:sack_polyisoprene_pellets'] += 1  # Extract_rubber
                    reward = self.reward_intermediate
                    step_cost = 50000
                else:
                    result = False
                    message = "No minecraft:log near tree_tap"
            else:
                result = False
    ...
    def craft(self, item_to_craft):
        ...
        if False in have_all_ingredients.values():
            ...
            if item_to_craft == 'polycraft:tree_tap':
                step_cost = 360.0
            elif item_to_craft == 'polycraft:wooden_pogo_stick':
                step_cost = 480.0
        ...
        # Craft
            ...
            # If more than 1 ingredient needed, agent needs to be in front of minecraft:crafting_table
            if len(self.recipes[item_to_craft]['input']) > 1:
                self.update_block_in_front()
                if not self.block_in_front_str == 'minecraft:crafting_table':
                    if item_to_craft == 'polycraft:tree_tap':
                        step_cost = 720.0
                    elif item_to_craft == 'polycraft:wooden_pogo_stick':
                        step_cost = 840.0
                    result = False
                    message = 'Need to be in front of minecraft:crafting_table'
            ...
            if item_to_craft == 'minecraft:planks':
                step_cost = 1200.0
            elif item_to_craft == 'minecraft:stick':
                step_cost = 2400.0
            elif item_to_craft == 'polycraft:tree_tap':
                step_cost = 7200.0
            elif item_to_craft == 'polycraft:wooden_pogo_stick':
                step_cost = 8400.0
